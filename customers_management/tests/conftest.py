...
def test_client():
    from customers_management.src.main import app, init_db
    from customers_management.src.models.database import db_session, base
    from customers_management.src.models.customers import Customers
    from customers_management.src.models.stores import Stores
